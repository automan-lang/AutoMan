...
// survey with swerve-kills-execs
object moral_machine_survey_1 extends App {
  ...
  def which_survey() = surveyGrammar(
    ...
    questions = List(
      ...
      nop => radioGrammar(
        grammar = scenarioGrammar,
        image_url = "https://mturk-moral-machine.s3.us-east-2.amazonaws.com/swerve_execs.png",
        image_alt_text = "If the car continues straight, two homeless people crossing the street will die. If it swerves, a male executive and a female executive crossing the street will die.",
        //minimum_spawn_policy = UserDefinableSpawnPolicy(0),
        question = question2Prod,
        depth = 2,
        variant = 86 //todo add variantArr option
      )(nop),
      nop => freetextGrammar(
