...
import org.automanlang.core.answer.MultiEstimate
...
class MTurkMultiEstimationTestSymmetricCI extends FlatSpec with Matchers {
  "An estimation program" should "work" in {
    val confidence = 0.95
    val ci = SymmetricCI(60)
    // from R using rnorm(500, mean = 633, sd = 100)
    // mean = 623.87
    // n = 500
    // sd = 99.1885
    val responses = List[Double](630,656,598,586,607,629,715,632,645,670,
