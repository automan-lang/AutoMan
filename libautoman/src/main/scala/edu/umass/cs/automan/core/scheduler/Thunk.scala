...
class Thunk[T](val thunk_id: UUID,
  ...
  def this(thunk_id: UUID,
           ...
           from_memo: Boolean) {
    this(thunk_id, question, timeout_in_s, worker_timeout, cost, created_at, state, from_memo, None, None, None)
  ...
  def copy_as_running() = {
    ...
    new Thunk[T](thunk_id, question, timeout_in_s, worker_timeout, cost, created_at, SchedulerState.RUNNING, from_memo, worker_id, answer, None)
  }
  def copy_with_answer(ans: T, wrk_id: String) = {
    ...
    new Thunk[T](thunk_id, question, timeout_in_s, worker_timeout, cost, created_at, SchedulerState.RETRIEVED, from_memo, Some(wrk_id), Some(ans), Some(new Date()))
  }
  def copy_as_timeout() = {
    ...
    new Thunk[T](thunk_id, question, timeout_in_s, worker_timeout, cost, created_at, SchedulerState.TIMEOUT, from_memo, worker_id, answer, Some(new Date()))
  }
  def copy_as_processed() = {
    ...
    new Thunk[T](thunk_id, question, timeout_in_s, worker_timeout, cost, created_at, SchedulerState.PROCESSED, from_memo, worker_id, answer, None)
  }
  def copy_as_cancelled() = {
    ...
    new Thunk[T](thunk_id, question, timeout_in_s, worker_timeout, cost, created_at, SchedulerState.CANCELLED, from_memo, worker_id, answer, Some(new Date()))
  }
  def copy_as_accepted() = {
    ...
    new Thunk[T](thunk_id, question, timeout_in_s, worker_timeout, cost, created_at, SchedulerState.ACCEPTED, from_memo, worker_id, answer, None)
  }
  def copy_as_rejected() = {
    ...
    new Thunk[T](thunk_id, question, timeout_in_s, worker_timeout, cost, created_at, SchedulerState.REJECTED, from_memo, worker_id, answer, None)
  }
