...
class CheckboxScalarAnswer(override val conf: Option[Double], override val worker_id: String, val values: Set[Symbol]) extends ScalarAnswer(conf: Option[Double], worker_id: String) {
