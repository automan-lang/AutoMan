...
import org.automanlang.core.logging.Memo
import org.automanlang.core.question.{CheckboxQuestion, CheckboxVectorQuestion, EstimationQuestion, FreeTextQuestion, FreeTextVectorQuestion, MultiEstimationQuestion, QuestionOption, RadioButtonQuestion, RadioButtonVectorQuestion}
...
abstract class NoOpAdapter extends AutomanAdapter {
  ...
  /**
    ...
    */
  override protected[automanlang] def accept(ts: List[Task]): Option[List[Task]] = None
  ...
  /**
    ...
    */
  override protected[automanlang] def backend_budget(): Option[BigDecimal] = None
  ...
  /**
    ...
    */
override protected[automanlang] def cancel(ts: List[Task], toState: SchedulerState.Value): Option[List[Task]] = None
  ...
  /**
    ...
    */
override protected[automanlang] def post(ts: List[Task], exclude_worker_ids: List[String]): Option[List[Task]] = None
   ...
   */
override protected[automanlang] def reject(ts_reasons: List[(Task, String)]): Option[List[Task]] = None
   ...
   */
override protected[automanlang] def retrieve(ts: List[Task], current_time: Date): Option[List[Task]] = None
